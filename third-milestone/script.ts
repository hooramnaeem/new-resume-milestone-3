...
,font-family: Arial, sans-serif; color: #333; max-width: 800px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
            <h2 style="text-align: center; color: #00008B; font-size: 24px text-decoration:underline ">${name}'s Resume</h2>
 ...
 margin-bottom: 20px;"><img src="${profilePictureDataUrl}" alt="Profile Picture" style="max-width: 150px; border-radius: 30%;" /></div>` : ''}
            ...
            <div style="line-height: 1.6;">
                <p style="font-size: 18px box-shadow: 0px 8px 12px rgba(173, 216, 230, 0.5); color: #00008B;"><strong>Email:</strong> ${email}</p>
                <p style="font-size: 18px box-shadow: 0px 8px 12px rgba(173, 216, 230, 0.5); color: #00008B;"><strong>Phone:</strong> ${phone}</p>
                <p style="font-size: 18px  box-shadow: 0px 8px 12px rgba(173, 216, 230, 0.5);color: #00008B;"><strong>Career Objective:</strong> ${objective}</p>
